      ...
      <main className="max-w-2xl mx-auto px-4 py-16 flex-1 flex flex-col items-center text-center">
        ...
        {order && order.productos && order.productos.length > 0 && (
          <div className="w-full mt-8 mb-8">
            <h2 className="text-xl font-bold mb-4 text-left text-[#3a1859] dark:text-white">
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1">
                        <h3 className="font-bold text-[#3a1859] dark:text-white">
                          {p.nombre}
                        </h3>
                        {p.sku && (
                      ...
                      <div className="text-right">
                        <p className="text-sm font-bold text-[#3a1859] dark:text-white">
            ...
            {(order.subtotal !== undefined || order.descuentoTotal !== undefined || order.total !== undefined) && (
              <div className="mt-6 p-4 bg-slate-100 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700">
                ...
                <div className="flex justify-between text-lg font-bold text-[#3a1859] dark:text-white pt-2 border-t border-slate-300 dark:border-slate-600">
                  <span>Total:</span>
