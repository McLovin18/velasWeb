...
const socialLinks = [
  { href: "https://www.instagram.com/luminavelas/", label: "Instagram", Icon: IconInstagram },
  { href: "https://www.tiktok.com/@luminavelas", label: "TikTok", Icon: IconTikTok },
];
      ...
      <footer className={styles.pdxFooter}>
            ...
            <div className={styles.ftLegalWrap}>
              <div className={styles.ftLegalRow}>
                <span className={styles.ftLegalBrand}>
                  Lumina Velas - Información de contacto:
                </span>
                ...
                <span className={styles.ftLegalSeparator}>|</span>
                <a
                  href="mailto:luminavelas@gmail.com"
                  className={styles.ftLegalLink}
                >
                  luminavelas@gmail.com
                </a>
                <span className={styles.ftLegalSeparator}>|</span>
                <a
        ...
        <div className={styles.ftCopyRow}>
          <p className={styles.ftCopyText}>
            © {new Date().getFullYear()} Lumina Velas 2026. Todos los derechos reservados.
          </p>
